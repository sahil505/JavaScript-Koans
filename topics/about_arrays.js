...
test("splice", function() {
    ...
    var workingWeek = daysOfWeek.splice(2, 2);
    ok(workingWeek.equalTo(['Wednesday', 'Thursday']), 'what is the value of workingWeek?');
    ok(daysOfWeek.equalTo(['Monday', 'Tuesday', 'Friday', 'Saturday', 'Sunday']), 'what is the value of daysOfWeek?');
});
